<template>
  <div class="overlay" @click="$parent.$emit('closeAddForm', 'addKnot')">
    <div class="modal-created" v-on:click.stop="">
      <div class="attention-close">
        ...
        <div class="attention-body">
          ...
          >
            ...
            <option :value="item.id" :key="item.id" v-for="item in workshops">
              {{ item.name }}
            </option>
          </select>
        </div>
      ...
      <button class="btn_icon2">
        <div
          class="btn-bg"
          @click="$parent.$emit('closeAddForm', 'addKnot')"
        ></div>
      </button>
    </div>
  </div>
  ...
  methods: {
    ...
    recForms() {
      if (this.id) {
        ...
        this.form.reserves1 = knots[0].reserv1_id;
        this.form.reserves2 = knots[0].reserv2_id;
        this.form.organisations = knots[0].organisation_id;
        this.form.companies = knots[0].company_id;
        this.form.factories = knots[0].factory_id;
        this.form.workshops = knots[0].workshop_id;
      }
    },
