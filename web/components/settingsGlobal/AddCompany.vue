<template>
  <div class="overlay"
  @click="$parent.$emit('closeAddForm', 'addCompany')">
      ...
      <div class="attention-close">
        ...
        <div class="attention-body">
          ...
          >
            ...
            <option :value="item.id" :key="item.id" v-for="item in lists.reserves1">
              {{ item.name }}
            </option>
          </select>
          <select
          ...
          >
            ...
            <option :value="item.id" :key="item.id" v-for="item in lists.reserves2">
              {{ item.name }}
            </option>
          </select>
          <select
...
export default {
  ...
  methods: {
    ...
    recForms() {
      ...
      this.form.reserves1 = companies[0].reserv1_id;
      this.form.reserves2 = companies[0].reserv2_id;
      this.form.organisations = companies[0].organisation_id;
    }
    },
